...
BOARD_MKBOOTIMG_ARGS  := --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --tags_offset 0x0e000000 --board CY-X557-H807
TARGET_PREBUILT_KERNEL := device/Infinix/X557/prebuilt/kernel
...
# RECOVERY
TARGET_RECOVERY_FSTAB := device/Infinix/X557/twrp.fstab
...
# building of an OEM friendly TWRP. excludes SuperSu, uses Toolbox instead busybox, disables themeing. [ false = disable ; true = allow ]
TW_OEM_BUILD := false
TW_DEFAULT_BRIGHTNESS := 150
TW_DEFAULT_LANGUAGE := en-US
# Log touch input [FOR DEVICE WITH TOUCH ISSUE{i guess}]
#start -here
